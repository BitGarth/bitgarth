CREATE TABLE payment_subject_new (
    ...
    last_refresh_status TEXT NULL CHECK(last_refresh_status IS NULL OR last_refresh_status IN ('active', 'revoked', 'unavailable', 'error', 'sync_warning', 'recovery_failed')),
